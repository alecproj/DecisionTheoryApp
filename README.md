  ...
  frontend/                 # Статичный фронтенд (локально и для GitHub Pages)
    src/                    # Исходники фронта
      css/                  # Стили интерфейса
        ...
        report.css          # Стили страницы просмотра отчёта
      js/                   # Логика фронта: API-запросы или работа с моками
        index.js            # JS скрипты страницы выбора алгоритма
        input.js            # JS скрипты страницы ввода входных данных
        report.js           # JS скрипты страницы просмотра отчёта
